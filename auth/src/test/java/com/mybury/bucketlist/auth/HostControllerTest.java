...
import com.mybury.bucketlist.auth.vo.SupportHistoryResponseVO;
...
public class HostControllerTest {
	...
	private static final String TEST_USER = "2c9fd4f0791e114b0179478ccb7902fd";
	...
	public void setup() {
		this.mockMvc = MockMvcBuilders.webAppContextSetup(this.webApplicationContext)
				...
				.alwaysDo(document("{method-name}",
						preprocessRequest(modifyUris().scheme("http").host("www.my-bury.com").removePort(),
								prettyPrint()),
	...
	public void testSignUpCheck() throws Exception {
		...
		this.mockMvc
				.perform(post(ApiUriConstants.SIGNUP_CHECK).contentType(MediaType.APPLICATION_JSON)
						.accept(MediaType.APPLICATION_JSON).content(objectMapper.writeValueAsString(requestVO)))
	...
	public void testSignUp() throws Exception {
		...
		this.mockMvc
				.perform(post(ApiUriConstants.SIGNUP).contentType(MediaType.APPLICATION_JSON)
						.accept(MediaType.APPLICATION_JSON).content(objectMapper.writeValueAsString(requestVO)))
				.andExpect(status().isOk());
	}
	...
	public void testSignIn() throws Exception {
		...
		requestVO.setUserId(TEST_USER);

		this.mockMvc
				.perform(post(ApiUriConstants.SIGNIN).contentType(MediaType.APPLICATION_JSON)
						.accept(MediaType.APPLICATION_JSON).content(objectMapper.writeValueAsString(requestVO)))
				.andExpect(status().isOk());
	}
	...
	public void testCreateProfile() throws Exception {
		...
		String accessToken = jwtUtils.createAccessToken(TEST_USER);

		Resource resource = resourceLoader.getResource("classpath:static/img/test.jpg");
		File file = resource.getFile();

		FileInputStream fis = new FileInputStream(file);
		MockMultipartFile mockFile = new MockMultipartFile("profile", "test.jpg", "image/jpg",
				IOUtils.toByteArray(fis));

		this.mockMvc
				.perform(multipart(ApiUriConstants.PROFILE).header("X-Auth-Token", accessToken)
						.param("userId", TEST_USER).param("name", "lion").param("defaultImg", "true"))
				.andExpect(status().isOk());
	}

	@Test
	public void testHome() throws Exception {
		User user = userRepository.findById(TEST_USER).get();
		...
		this.mockMvc
				.perform(get(ApiUriConstants.HOME).header("X-Auth-Token", accessToken).param("userId", TEST_USER)
						.param("filter", "started").param("sort", "updatedDt").accept(MediaType.APPLICATION_JSON))
				.andDo(print()).andExpect(status().isOk())
		/*
		 * .andDo(document("test-home", responseFields(
	...
	public void testDDay() throws Exception {
		...
		this.mockMvc
				.perform(get(ApiUriConstants.D_DAY).header("X-Auth-Token", accessToken).param("userId", TEST_USER)
						.param("filter", "minus").accept(MediaType.APPLICATION_JSON))
				.andDo(print()).andExpect(status().isOk())
	...
	public void testCompleteBucketlist() throws Exception {
		...
		this.mockMvc.perform(post(ApiUriConstants.BUCKETLIST_COMPLETE).header("X-Auth-Token", accessToken)
	...
	public void testCancelBucketlist() throws Exception {
		...
		this.mockMvc.perform(post(ApiUriConstants.BUCKETLIST_CANCEL).header("X-Auth-Token", accessToken)
				.contentType(MediaType.APPLICATION_JSON).accept(MediaType.APPLICATION_JSON)
				.content(objectMapper.writeValueAsString(requestVO))).andExpect(status().isOk())
		/* .andDo(document("host-completeBucketlist")) */;
	}
	...
	public void testPinBucketlist() throws Exception {
		...
		this.mockMvc.perform(post(ApiUriConstants.BUCKETLIST_PIN).header("X-Auth-Token", accessToken)
				.contentType(MediaType.APPLICATION_JSON).accept(MediaType.APPLICATION_JSON)
				.content(objectMapper.writeValueAsString(requestVO))).andExpect(status().isOk())
	...
	public void testBeforeWrite() throws Exception {
		...
		this.mockMvc
				.perform(get(ApiUriConstants.BUCKETLIST_BEFORE_WRITE).header("X-Auth-Token", accessToken)
						.param("userId", TEST_USER).accept(MediaType.APPLICATION_JSON))
				.andDo(print()).andExpect(status().isOk());
	}
	...
	public void testWrite() throws Exception {
		...
		FileInputStream fis = new FileInputStream(file);
		MockMultipartFile mockFile1 = new MockMultipartFile("profile", "test.jpg", "image/jpg",
				IOUtils.toByteArray(fis));
		MockMultipartFile mockFile2 = new MockMultipartFile("profile", "test.jpeg", "image/jpg",
				IOUtils.toByteArray(fis));
		MockMultipartFile mockFile3 = new MockMultipartFile("profile", "test.jpeg", "image/jpg",
				IOUtils.toByteArray(fis));
		...
		this.mockMvc.perform(multipart(ApiUriConstants.BUCKETLIST_WRITE)
				 ...
				 */
				.header("X-Auth-Token", accessToken).param("title", "Title!!").param("open", "true")
				.param("dDate", "2019-12-25").param("goalCount", "10").param("memo", "Memo!!")
				.param("categoryId", category.getId()).param("userId", TEST_USER)).andExpect(status().isOk());
	}
	...
	public void testGetBucketlist() throws Exception {
		...
		this.mockMvc.perform(get(StringUtils.replace(ApiUriConstants.BUCKETLIST_CRUD, "{id}", bucketlist.getId()))
				.header("X-Auth-Token", accessToken).param("userId", TEST_USER).accept(MediaType.APPLICATION_JSON))
				.andDo(print()).andExpect(status().isOk());
	}
	...
	public void testModifyBucketlist() throws Exception {
		...
		this.mockMvc.perform(multipart(StringUtils.replace(ApiUriConstants.BUCKETLIST_CRUD, "{id}", bucketlist.getId()))
				 ...
				 * .file(mockFile1) .file(mockFile2) .file(mockFile3)
				 */
				.header("X-Auth-Token", accessToken).param("id", bucketlist.getId())
				.param("title", bucketlist.getTitle()).param("open", "true").param("dDate", "2020-10-22")
				.param("goalCount", String.valueOf(bucketlist.getGoalCount())).param("memo", bucketlist.getMemo())
				.param("categoryId", category.getId()).param("userId", TEST_USER).param("removeImg1", "true")
				.param("removeImg2", "true").param("removeImg3", "true")).andExpect(status().isOk());
	}
	...
	public void testRemoveBucketlist() throws Exception {
		...
		this.mockMvc
				.perform(MockMvcRequestBuilders
						...
						.header("X-Auth-Token", accessToken).contentType(MediaType.APPLICATION_JSON)
						.accept(MediaType.APPLICATION_JSON).content(objectMapper.writeValueAsString(requestVO)))
				.andExpect(status().isOk());
	}
	...
	public void testMyPage() throws Exception {
		User user = userRepository.findById(TEST_USER).orElse(null);
...
//		user = userRepository.save(user);
		...
		this.mockMvc.perform(get(ApiUriConstants.MYPAGE).header("X-Auth-Token", accessToken).param("userId", TEST_USER)
	...
	public void testGetCategory() throws Exception {
		...
		this.mockMvc
				.perform(get(ApiUriConstants.CATEGORY).header("X-Auth-Token", accessToken).param("userId", TEST_USER)
						.param("categoryId", category.getId()).accept(MediaType.APPLICATION_JSON))
				.andDo(print()).andExpect(status().isOk());
	}
	...
	public void testCreateCategory() throws Exception {
		...
		this.mockMvc.perform(post(ApiUriConstants.CATEGORY).header("X-Auth-Token", accessToken)
				.contentType(MediaType.APPLICATION_JSON).accept(MediaType.APPLICATION_JSON)
				.content(objectMapper.writeValueAsString(requestVO))).andExpect(status().isOk());
	}
	...
	public void testModifyNameCategory() throws Exception {
		...
		this.mockMvc.perform(post(ApiUriConstants.CATEGORY_EDIT_NAME).header("X-Auth-Token", accessToken)
				.contentType(MediaType.APPLICATION_JSON).accept(MediaType.APPLICATION_JSON)
				.content(objectMapper.writeValueAsString(requestVO))).andExpect(status().isOk());
	}
	...
	public void testModifyPriorityCategory() throws Exception {
		...
		this.mockMvc.perform(post(ApiUriConstants.CATEGORY_EDIT_PRIORITY).header("X-Auth-Token", accessToken)
				.contentType(MediaType.APPLICATION_JSON).accept(MediaType.APPLICATION_JSON)
				.content(objectMapper.writeValueAsString(requestVO))).andExpect(status().isOk());
	}
	...
	public void testRemoveCategory() throws Exception {
		...
		this.mockMvc.perform(MockMvcRequestBuilders.delete(ApiUriConstants.CATEGORY).header("X-Auth-Token", accessToken)
				.contentType(MediaType.APPLICATION_JSON).accept(MediaType.APPLICATION_JSON)
				.content(objectMapper.writeValueAsString(requestVO))).andExpect(status().isOk());
	}
	...
	public void testRefreshToken() throws Exception {
		...
		RefreshTokenRequestVO requestVO = new RefreshTokenRequestVO(TEST_USER, refreshToken);

		this.mockMvc
				.perform(post(ApiUriConstants.REFRESH_TOKEN).contentType(MediaType.APPLICATION_JSON)
						.accept(MediaType.APPLICATION_JSON).content(objectMapper.writeValueAsString(requestVO)))
				.andExpect(status().isOk());
	}
	...
	public void testSupport() throws Exception {
		...
		this.mockMvc.perform(post(ApiUriConstants.SUPPORT).header("X-Auth-Token", accessToken)
				.contentType(MediaType.APPLICATION_JSON).accept(MediaType.APPLICATION_JSON)
				.content(objectMapper.writeValueAsString(requestVO))).andExpect(status().isOk());
	...
	public void testSupportItems() throws Exception {
		...
		this.mockMvc.perform(post(ApiUriConstants.SUPPORT_ITEMS).header("X-Auth-Token", accessToken)
				.contentType(MediaType.APPLICATION_JSON).accept(MediaType.APPLICATION_JSON)
				.content(objectMapper.writeValueAsString(requestVO))).andExpect(status().isOk());
	}
	...
	public void testSupportEdit() throws Exception {
		...
		this.mockMvc.perform(post(ApiUriConstants.SUPPORT_EDIT).header("X-Auth-Token", accessToken)
				.contentType(MediaType.APPLICATION_JSON).accept(MediaType.APPLICATION_JSON)
				.content(objectMapper.writeValueAsString(requestVO))).andExpect(status().isOk());
	}
...
//		String accessToken = jwtUtils.createAccessToken(TEST_USER);
//
//		this.mockMvc.perform(get(ApiUriConstants.NOTICE).header("X-Auth-Token", accessToken))
//				.andExpect(status().isOk());
//	}

	@Test
	public void changeOrder() throws Exception {
		String accessToken = jwtUtils.createAccessToken("2c9fd37570043f940170108718cf0021");

		ChangeOrderListDTO dto = new ChangeOrderListDTO();
		dto.setUserId("2c9fd37570043f940170108718cf0021");

		List<String> list = new ArrayList<String>();
		list.add("2c9fd4f0791e114b0179478ce32102fe");
		list.add("2c9fd4f0791e114b0179478cf77602ff");
		dto.setOrders(list);

		mockMvc.perform(post("/change_order").header("X-Auth-Token", accessToken)).andExpect(status().isOk());
	}
}

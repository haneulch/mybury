package com.mybury.bucketlist.auth.constants;
...
public class ApiUriConstants {
	...
	public static final String BUCKETLIST_REDO = "/redo";
	...
	/* 후원하기 */
	public static final String SUPPORT_ITEMS_EDIT = "/support_items_edit";
	public static final String SUPPORT_ITEMS = "/support_items";
	public static final String SUPPORT = "/support";
	public static final String SUPPORT_EDIT = "/support_edit";

	/* 공지사항 */
	public static final String NOTICE = "/notice";
	public static final String NOTICE_SAVE = "/save_notice";
}
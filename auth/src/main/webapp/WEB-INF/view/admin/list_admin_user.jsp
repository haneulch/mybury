							...
							<table class="table table-striped text-center text-vertical-middle">
								...
								<tbody>
									<tr v-for="item in content">
										...
										<td><a href="javascript:void(0)" class="btn btn-primary btn-sm" @click="initKey(item.username)">초기화</a></td>
										<td><a href="javascript:void(0)" class="btn btn-danger btn-sm" @click="deleteUser(item.username)">삭제</a></td>
									</tr>
								</tbody>
							</table>
						</div>

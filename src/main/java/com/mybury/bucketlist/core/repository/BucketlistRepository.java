...
public interface BucketlistRepository extends JpaRepository<Bucketlist, String>, BucketlistRepositoryCustom {
	List<Bucketlist> findByDueDateIsNotNullAndUser_Id(String userId);
	List<BucketlistVO> findByTitleContainingAndUser_Id(String searchText, String userId);
	List<BucketlistVO> findByDueDateNotNullAndTitleContainingAndUser_Id(String searchText, String userId);
	List<BucketlistVO> findByDueDateIsNull();
	...
	List<BucketlistResult> findProjectionByDueDateIsNotNullAndUser_Id(String userId);
}
